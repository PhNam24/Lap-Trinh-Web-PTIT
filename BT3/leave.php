<?php
    ...
    if (isset($_SESSION['username']) && isset($_SESSION['user_type']) && $_SESSION['logged_in']) {
        ...
        <head>
            ...
            <link href="https://cdn.datatables.net/v/bs5/dt-2.0.5/datatables.min.css" rel="stylesheet"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
                                    ...
                                    <table id="staff_table" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query1 = "select * from nghi_phep_tbl inner join nhan_vien_tbl on nghi_phep_tbl.id_nhanvien=nhan_vien_tbl.id_nv";
                                                $leave_result = $sql_connect->query($query1);
                                                ...
                                                while ($row = $leave_result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php 
                                                            if ($row['trang_thai'] == 1) {
                                                                echo '<a href="#" class="btn btn-success px-4 disabled">Đã chấp nhận</a>';
                                                            }
                                                            else if ($row['trang_thai'] == 0) {
                                                                echo '<a href="#" class="btn btn-danger px-4 mx-2 disabled">Đã từ chối</a>';
                                                            }
                                                            else if ($row['trang_thai'] == 2) {
                                                                echo '<a href="#" class="btn btn-secondary px-4 mx-2 disabled">Chưa duyệt</a>';
                                                            }
                                                         ?></td>
                                                        <td>
                                                            <a href="edit_leave.php?id=<?php echo $row['id_nghi']; ?>&state=1" class="btn btn-success px-4"> <i class="bi bi-check-circle-fill"></i></a>
                                                            <a href="edit_leave.php?id=<?php echo $row['id_nghi']; ?>&state=0" class="btn btn-danger px-4"><i class="bi bi-x-circle-fill"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
