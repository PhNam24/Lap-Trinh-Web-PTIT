                                            ...
                                            <?php
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_department.php?id=<?php echo $row['id_cv']; ?>" class="btn btn-success px-4">Sửa</a>
                                                            <a onclick="return confirm('Bạn có chắc muốn xoá chức vụ này không?');" href="delete_department.php?id=<?php echo $row['id_cv']; ?>" class="btn btn-danger px-4">Xoá</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
