                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-4 pb-2">
                                                ...
                                                <div class="form-outline">
                                                    ...
                                                    <input type="text" name="luong_co_ban" id="luong_co_ban" class="form-control form-control-lg" oninput="updateSalary(this.value)"/>
                                            ...
                                            <div class="col-md-4 mb-4 pb-2">
                                                ...
                                                <div class="form-outline">
                                                    ...
                                                    <input type="tel" name="phu_cap" id="phu_cap" class="form-control form-control-lg" oninput="updateSalary(this.value )"/>
                                                </div>
                                            ...
                                            <div class="col-md-4 mb-4 pb-2">
                                                ...
                                                <div class="form-outline">
                                                    ...
                                                    <input type="tel" name="tong_luong" class="form-control form-control-lg" id="tong_luong"/>
                                                </div>
