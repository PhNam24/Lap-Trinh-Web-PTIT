<?php
    ...
    if (isset($_POST['submit'])) {
        if (empty($_POST['department_name'])) {
            ...
            $query = "INSERT INTO chuc_vu_tbl(id, chuc_vu, ngay_them) VALUES (NULL,'$department_name',NULL);";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <br>
                                        <input type= "submit" name="submit" class="btn btn-lg btn-success float-end" value="Thêm mới"></input>
                                    </form>
                                </div>
                            </div>
                        </div>
