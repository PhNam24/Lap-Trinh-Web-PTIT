                                            ...
                                            <?php
                                                ...
                                                while ($row = $staff_result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_salary.php?id=<?php echo $row['id_nv']; ?>" class="btn btn-success px-4">Sửa</a>
                                                            <a onclick="return confirm('Bạn có chắc muốn xoá bảng lương này không?');" href="delete_staff.php?id=<?php echo $row['id_nv']; ?>" class="btn btn-danger px-4">Xoá</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
